        ...
        <div>
            ...
            <div className="container mx-auto p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><strong>Category:</strong> {userData?.category}</li>
                            <li><strong>Hometown:</strong> {userData?.hometown}</li>
                ...
                <div className="mt-8">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        <ul className="space-y-2">
                            <li><strong>Has Gap:</strong> {userData?.gaps.hasGap}</li>
                            <li><strong>Number of Years:</strong> {userData?.gaps.numberOfYears}</li>
                            <li><strong>Active Backlogs:</strong> {userData?.backlogs.hasActiveBacklogs}</li>
                            <li><strong>Total Active Backlogs:</strong> {userData?.backlogs.totalActiveBacklogs}</li>
                        </ul>
                    </div>
                </div>
